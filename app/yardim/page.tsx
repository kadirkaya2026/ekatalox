...
const faqs = [
  ...
  { q: 'Planımı istediğim zaman iptal edebilir miyim?', a: 'Evet. Workspace ayarlarından tek tıkla iptal edebilirsiniz. Yıllık ödeme yaptıysanız kalan dönem için ücret iadesi yapılmaz; aylık ödemede ise kalan günler için ayrıca ücret alınmaz. Vitrinleriniz 30 gün boyunca arka planda saklanır.' },
  { q: 'Müşterilerim sipariş vermek için nasıl giriş yapar?', a: 'Vitrininizin linkini doğrudan müşterinize gönderirsiniz. Hangi fiyat listesini görmesini istiyorsanız (Bayi/Toptan/Anlaşmalı), o müşteriye o listeye özel bir şifre atarsınız. Müşteriniz linke girip bu şifreyi yazdığında, yalnızca kendisine atanan fiyat seviyesini görür.' },

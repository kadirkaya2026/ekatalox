...
export function buildWhatsAppMessage(params: {
  ...
  // Müşterinin isteğe bağlı paylaştığı konumun HAZIR linki (sunucu kısaltır,
  // bkz. lib/storage/short-links.ts). Adresin YERİNE geçmez, onu tamamlar:
  // bina içinde GPS şaşabildiği için kapı/kat bilgisi yine adresten gelir.

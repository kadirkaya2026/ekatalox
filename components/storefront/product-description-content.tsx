    ...
    return (
      <div
        className={cn(
          ...
          "[&_blockquote]:my-2 [&_blockquote]:border-l-4 [&_blockquote]:pl-3",
          theme.proseBlockquoteBlock,
          "[&_table]:my-3 [&_table]:w-full [&_table]:border-collapse [&_table]:text-sm",
          "[&_th]:border [&_th]:px-2 [&_th]:py-1.5 [&_th]:text-left [&_th]:font-semibold",
          theme.proseTableHeadBlock,
          "[&_td]:border [&_td]:px-2 [&_td]:py-1.5",
          theme.proseTableCellBlock,
          className,
        )}
